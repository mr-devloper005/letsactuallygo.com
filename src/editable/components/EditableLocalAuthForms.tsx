...
const inputClass = 'h-12 border border-[var(--slot4-border)] bg-white px-4 text-base font-semibold text-[var(--slot4-page-text)] outline-none transition placeholder:text-[var(--slot4-soft-muted-text)] focus:border-[var(--slot4-accent-fill)]'
const buttonClass = 'inline-flex h-12 items-center justify-center bg-[#1a3263] px-6 text-sm font-black uppercase tracking-[0.18em] text-white transition duration-300 hover:-translate-y-1 disabled:opacity-60'
